...
The classic. Concatenated SQL meets attacker-controlled input; the attacker gets to write the query.

By the end of this week you'll be able to:
- UNION-based, error-based, blind, and time-based SQLi
- ORM use vs. raw SQL
- Parameterized queries — the only real defense
- Second-order SQLi (stored payload, executed later)
