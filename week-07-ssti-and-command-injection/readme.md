# Week 07: Server-Side Template Injection & Command Injection

## 🎯 What you'll learn

When user input gets interpolated into templates (Jinja, ERB, Velocity) or shell commands, an attacker can take over the server.

By the end of this week you'll be able to:
- SSTI detection (`{{7*7}}` pattern)
- Engine-specific RCE chains (Jinja `__class__`, Velocity, Twig)
- Command injection via subprocess concatenation
- Argument injection and binary-specific tricks
