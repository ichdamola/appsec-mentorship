...
Weak crypto, secrets in code, password storage failures, timing attacks. OWASP A02.

By the end of this week you'll be able to:
- Password hashing (bcrypt, argon2, scrypt — never SHA256)
- Hardcoded keys and `.env` leakage
- Weak randomness (`Math.random()` for tokens)
- Padding oracle and timing-based key recovery
