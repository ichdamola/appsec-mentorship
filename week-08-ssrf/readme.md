...
Get the server to make HTTP requests on your behalf — to internal services, cloud metadata, or the loopback. One of the highest-impact bug classes.

By the end of this week you'll be able to:
- Cloud metadata abuse (AWS IMDSv1, GCP metadata)
- Bypassing localhost / RFC1918 filters
- Blind SSRF and out-of-band detection
- SSRF via PDF generators, webhooks, and URL preview features
