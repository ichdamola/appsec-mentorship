...
Untrusted bytes get reconstructed into objects with executable behavior — Java `readObject`, Python `pickle`, PHP `unserialize`, .NET formatters.

By the end of this week you'll be able to:
- Gadget chains and the ysoserial toolkit
- Python pickle RCE
- PHP object injection
- Why JSON is safer than language-native serialization
