...
The browser's same-origin model — the foundation that protects users from cross-site attacks, and the misconfigurations that break it.

By the end of this week you'll be able to:
- CSRF via session-riding form POSTs
- SameSite cookie behavior (Lax, Strict, None)
- CORS misconfiguration (wildcard + credentials)
- Origin reflection bugs
